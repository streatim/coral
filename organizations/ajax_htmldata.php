...
switch ($_GET['action']) {
  ...
  case 'getResourceIssueDetails':
    ...
    $organization = new Organization(new NamedArguments(array('primaryKey' => $organizationID)));
    $exportIssues = $organization->getExportableIssues();
    $exportIssuesArchived = $organization->getExportableIssues(true);
    $exportDowntimes = $organization->getExportableDowntimes();
    $exportDowntimesArchived = $organization->getExportableDowntimes(true);
        ...
        <tr>
          <?php if ($_GET['contactName']) { ?>
            <th>
              <table class='noBorderTable'>
                <tr>
                  <td><?php echo _("Contact Name(s)"); ?></td>
                  <td class='arrow'><a href='javascript:setOrder("C.name","asc");'><img src='images/arrowup.png' border=0></a>&nbsp;<a href='javascript:setOrder("C.name","desc");'><img src='images/arrowdown.png' border=0></a></td>
                </tr>
              </table>
            </th>
            <th>
              <table class='noBorderTable'>
                <tr>
                  <td><?php echo _("Contact Role(s)"); ?></td>
                  <td class='arrow'><a href='javascript:setOrder("O.name","asc");'><img src='images/arrowup.png' border=0></a>&nbsp;<a href='javascript:setOrder("O.name","desc");'><img src='images/arrowdown.png' border=0></a></td>
                </tr>
              </table>
            </th>
            <th>
            ...
            <th>
              <table class='noBorderTable'>
                <tr>
                  <td><?php echo _("Parent Organization"); ?></td>
                  <td class='arrow'><a href='javascript:setOrder("OP.name","asc");'><img src='images/arrowup.png' border=0></a>&nbsp;<a href='javascript:setOrder("OP.name","desc");'><img src='images/arrowdown.png' border=0></a></td>
                </tr>
              </table>
            </th>
            <th>
              <table class='noBorderTable'>
                <tr>
                  <td><?php echo _("Organization Role(s)"); ?></td>
                  <td class='arrow'><a href='javascript:setOrder("orgRoles","asc");'><img src='images/arrowup.png' border=0></a>&nbsp;<a href='javascript:setOrder("orgRoles","desc");'><img src='images/arrowdown.png' border=0></a></td>
                </tr>
              </table>
            </th>
          ...
          <?php } else { ?>
            ...
            <th>
              <table class='noBorderTable'>
                <tr>
                  <td><?php echo _("Alias"); ?></td>
                  <td class='arrow'><a href='javascript:setOrder("Aliases","asc");'><img src='images/arrowup.png' border=0></a>&nbsp;<a href='javascript:setOrder("Aliases","desc");'><img src='images/arrowdown.png' border=0></a></td>
                </tr>
              </table>
            </th>
            <th>
